...
// Wed Jul 22 20:44:56 2015/KDAR_MC_files by ROOT version 4.00/08
// from TChain outputTree_joe/
//////////////////////////////////////////////////////////

#ifndef outputTree_joe_h
#define outputTree_joe_h
...
#include <TFile.h>
   ...
   const Int_t kMaxmyMCParticle = 84;
   ...
   const Int_t kMaxmysplitEvent = 2;
   const Int_t kMaxmyYBoostOut = 2;
   const Int_t kMaxmyAll = 2;
   const Int_t kMaxmyRFast = 2;
   const Int_t kMaxmyRFull = 2;
   const Int_t kMaxmyRPi0 = 2;
   const Int_t kMaxmyRTrak = 2;
   const Int_t kMaxmyTransRFull = 2;
   const Int_t kMaxmyTransRPi0 = 2;
   const Int_t kMaxmyTransRTrak = 2;
   const Int_t kMaxmyRecoCon = 2;
   const Int_t kMaxmyRecoDisj = 2;
   const Int_t kMaxmyRecoOneTrk = 2;
   const Int_t kMaxmyRecoTwoTrk = 2;
   const Int_t kMaxmyRecoOneTrkMu = 2;
   const Int_t kMaxmyRecoTwoTrkFix = 2;
   const Int_t kMaxmyStFast = 2;
   const Int_t kMaxmyStFlux = 2;
   const Int_t kMaxmyStFull = 2;
   const Int_t kMaxmyStPi0 = 2;
   const Int_t kMaxmyStTrak = 2;
   const Int_t kMaxmyStVarsTwo = 2;

class outputTree_joe {
public :
...
#ifdef outputTree_joe_cxx
outputTree_joe::outputTree_joe(TTree *tree)
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      tree = (TTree*)gDirectory->Get("outputTree_joe");

#else // SINGLE_TREE

      // The following code should be used if you want this class to access a chain
      // of trees.
      TChain * chain = new TChain("outputTree_joe","");
      chain->Add("./numi_reader_newtree_nocuts_00.root/outputTree");
      //chain->Add("/Volumes/Backups2015/KDAR_MC_files/numi_reader_newtree_nocuts_00.root/outputTree");
      /*
      chain->Add("/Volumes/Backups2015/KDAR_MC_files/numi_reader_newtree_nocuts_01.root/outputTree");
      chain->Add("/Volumes/Backups2015/KDAR_MC_files/numi_reader_newtree_nocuts_02.root/outputTree");
      chain->Add("/Volumes/Backups2015/KDAR_MC_files/numi_reader_newtree_nocuts_03.root/outputTree");
      chain->Add("/Volumes/Backups2015/KDAR_MC_files/numi_reader_newtree_nocuts_04.root/outputTree");
      chain->Add("/Volumes/Backups2015/KDAR_MC_files/numi_reader_newtree_nocuts_05.root/outputTree");
      chain->Add("/Volumes/Backups2015/KDAR_MC_files/numi_reader_newtree_nocuts_06.root/outputTree");
      chain->Add("/Volumes/Backups2015/KDAR_MC_files/numi_reader_newtree_nocuts_07.root/outputTree");
      chain->Add("/Volumes/Backups2015/KDAR_MC_files/numi_reader_newtree_nocuts_08.root/outputTree");
      chain->Add("/Volumes/Backups2015/KDAR_MC_files/numi_reader_newtree_nocuts_09.root/outputTree");
      chain->Add("/Volumes/Backups2015/KDAR_MC_files/numi_reader_newtree_nocuts_10.root/outputTree");
      chain->Add("/Volumes/Backups2015/KDAR_MC_files/numi_reader_newtree_nocuts_11.root/outputTree");
      chain->Add("/Volumes/Backups2015/KDAR_MC_files/numi_reader_newtree_nocuts_12.root/outputTree");
      chain->Add("/Volumes/Backups2015/KDAR_MC_files/numi_reader_newtree_nocuts_13.root/outputTree");
      chain->Add("/Volumes/Backups2015/KDAR_MC_files/numi_reader_newtree_nocuts_14.root/outputTree");
      chain->Add("/Volumes/Backups2015/KDAR_MC_files/numi_reader_newtree_nocuts_15.root/outputTree");
      chain->Add("/Volumes/Backups2015/KDAR_MC_files/numi_reader_newtree_nocuts_16.root/outputTree");
      chain->Add("/Volumes/Backups2015/KDAR_MC_files/numi_reader_newtree_nocuts_17.root/outputTree");
      chain->Add("/Volumes/Backups2015/KDAR_MC_files/numi_reader_newtree_nocuts_18.root/outputTree");
      chain->Add("/Volumes/Backups2015/KDAR_MC_files/numi_reader_newtree_nocuts_19.root/outputTree");
      chain->Add("/Volumes/Backups2015/KDAR_MC_files/numi_reader_newtree_nocuts_20.root/outputTree");
      chain->Add("/Volumes/Backups2015/KDAR_MC_files/numi_reader_newtree_nocuts_21.root/outputTree");
      chain->Add("/Volumes/Backups2015/KDAR_MC_files/numi_reader_newtree_nocuts_22.root/outputTree");
      chain->Add("/Volumes/Backups2015/KDAR_MC_files/numi_reader_newtree_nocuts_23.root/outputTree");
      chain->Add("/Volumes/Backups2015/KDAR_MC_files/numi_reader_newtree_nocuts_24.root/outputTree");
      chain->Add("/Volumes/Backups2015/KDAR_MC_files/numi_reader_newtree_nocuts_25.root/outputTree");
      chain->Add("/Volumes/Backups2015/KDAR_MC_files/numi_reader_newtree_nocuts_26.root/outputTree");
      chain->Add("/Volumes/Backups2015/KDAR_MC_files/numi_reader_newtree_nocuts_27.root/outputTree");
      chain->Add("/Volumes/Backups2015/KDAR_MC_files/numi_reader_newtree_nocuts_28.root/outputTree");
      chain->Add("/Volumes/Backups2015/KDAR_MC_files/numi_reader_newtree_nocuts_29.root/outputTree");
      chain->Add("/Volumes/Backups2015/KDAR_MC_files/numi_reader_newtree_nocuts_30.root/outputTree");
      chain->Add("/Volumes/Backups2015/KDAR_MC_files/numi_reader_newtree_nocuts_31.root/outputTree");
      chain->Add("/Volumes/Backups2015/KDAR_MC_files/numi_reader_newtree_nocuts_32.root/outputTree");
      chain->Add("/Volumes/Backups2015/KDAR_MC_files/numi_reader_newtree_nocuts_33.root/outputTree");
      chain->Add("/Volumes/Backups2015/KDAR_MC_files/numi_reader_newtree_nocuts_34.root/outputTree");
      chain->Add("/Volumes/Backups2015/KDAR_MC_files/numi_reader_newtree_nocuts_35.root/outputTree");
      chain->Add("/Volumes/Backups2015/KDAR_MC_files/numi_reader_newtree_nocuts_36.root/outputTree");
      chain->Add("/Volumes/Backups2015/KDAR_MC_files/numi_reader_newtree_nocuts_37.root/outputTree");
      chain->Add("/Volumes/Backups2015/KDAR_MC_files/numi_reader_newtree_nocuts_38.root/outputTree");
      chain->Add("/Volumes/Backups2015/KDAR_MC_files/numi_reader_newtree_nocuts_39.root/outputTree");
      chain->Add("/Volumes/Backups2015/KDAR_MC_files/numi_reader_newtree_nocuts_40.root/outputTree");
      chain->Add("/Volumes/Backups2015/KDAR_MC_files/numi_reader_newtree_nocuts_41.root/outputTree");
      chain->Add("/Volumes/Backups2015/KDAR_MC_files/numi_reader_newtree_nocuts_42.root/outputTree");
      chain->Add("/Volumes/Backups2015/KDAR_MC_files/numi_reader_newtree_nocuts_43.root/outputTree");
      chain->Add("/Volumes/Backups2015/KDAR_MC_files/numi_reader_newtree_nocuts_44.root/outputTree");
      chain->Add("/Volumes/Backups2015/KDAR_MC_files/numi_reader_newtree_nocuts_45.root/outputTree");
      chain->Add("/Volumes/Backups2015/KDAR_MC_files/numi_reader_newtree_nocuts_46.root/outputTree");  
      chain->Add("/Volumes/Backups2015/KDAR_MC_files/numi_reader_newtree_nocuts_47.root/outputTree");
      chain->Add("/Volumes/Backups2015/KDAR_MC_files/numi_reader_newtree_nocuts_48.root/outputTree");
      chain->Add("/Volumes/Backups2015/KDAR_MC_files/numi_reader_newtree_nocuts_49.root/outputTree");*/
      
      
      chain->Add("./strobe_twose_reader_0.root/outputTree");
      chain->Add("./strobe_twose_reader_1.root/outputTree");   
      chain->Add("./numi_just_dirt.root/outputTree");
            //chain->Add("./numi_data_nubar_newsub/rolling_data_numi_data_nubar_third.root/outputTree_joe");//data
      chain->Add("./numi_nubar_data_reader_final_22.root/outputTree");
      chain->Add("./numi_nubar_data_reader_final_23.root/outputTree");
      chain->Add("./numi_nubar_data_reader_final_24.root/outputTree");
      chain->Add("./numi_nubar_data_reader_final_25.root/outputTree");
      chain->Add("./numi_nubar_data_reader_final_26.root/outputTree");
      chain->Add("./numi_nubar_data_reader_final_27.root/outputTree");
      chain->Add("./numi_nubar_data_reader_final_28.root/outputTree");
      chain->Add("./numi_nubar_data_reader_final_35.root/outputTree");
      chain->Add("./numi_nubar_data_reader_final_36.root/outputTree");
      chain->Add("./numi_nubar_data_reader_final_37.root/outputTree");
      chain->Add("./numi_nubar_data_reader_final_38.root/outputTree");
      //chain->Add("./numi_nubar_data_reader_final_36_old.root/outputTree");
      //chain->Add("./numi_nubar_data_reader_final_37_old.root/outputTree");
      //chain->Add("./numi_nubar_data_reader_final_38_old.root/outputTree");

      /*
      chain->Add("./numi_data_nubar_newsub/numi_data_nubar_reader_22.root/outputTree_joe");
      chain->Add("./numi_data_nubar_newsub/numi_data_nubar_reader_23.root/outputTree_joe");
      chain->Add("./numi_data_nubar_newsub/numi_data_nubar_reader_24.root/outputTree_joe");
      chain->Add("./numi_data_nubar_newsub/numi_data_nubar_reader_25.root/outputTree_joe");
      chain->Add("./numi_data_nubar_newsub/numi_data_nubar_reader_26.root/outputTree_joe");
      chain->Add("./numi_data_nubar_newsub/numi_data_nubar_reader_27.root/outputTree_joe");
      chain->Add("./numi_data_nubar_newsub/numi_data_nubar_reader_28.root/outputTree_joe");
      chain->Add("./numi_data_nubar_newsub/numi_data_nubar_reader_35.root/outputTree_joe");
      chain->Add("./numi_data_nubar_newsub/numi_data_nubar_reader_36.root/outputTree_joe");
      chain->Add("./numi_data_nubar_newsub/numi_data_nubar_reader_37.root/outputTree_joe");
      chain->Add("./numi_data_nubar_newsub/numi_data_nubar_reader_38.root/outputTree_joe");
      chain->Add("./numi_data_nubar_newsub/numi_data_nubar_reader_39.root/outputTree_joe");
      */
      //chain->Add("../../numi_data_nubar_newsub/late_sample.root/outputTree_joe");
      tree = chain;
#endif // SINGLE_TREE
...
outputTree_joe::~outputTree_joe()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t outputTree_joe::GetEntry(Int_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Int_t outputTree_joe::LoadTree(Int_t entry)
{
...
void outputTree_joe::Init(TTree *tree)
{
...
void outputTree_joe::Show(Int_t entry)
{
...
Int_t outputTree_joe::Cut(Int_t entry)
{
...
#endif // #ifdef outputTree_joe_cxx
