...
// Sat Aug  1 13:43:24 2015 by ROOT version 4.00/08
...
#include <TChain.h>
#include <TFile.h>
   const Int_t kMaxmyHeader = 4;
   const Int_t kMaxmyTankHeader = 2;
   const Int_t kMaxmyMCEvent = 1;
   const Int_t kMaxmyMCParticle = 71;
   const Int_t kMaxmyMCParent = 7;
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      chain->Add("../nu_mc_newsub/nu_mc_reader_wEW_0.root/outputTree");
      chain->Add("../nu_mc_newsub/nu_mc_reader_wEW_1.root/outputTree");
      chain->Add("../nu_mc_newsub/nu_mc_reader_wEW_2.root/outputTree");
      //chain->Add("../strobe_newsub/strobe_twose_reader_0.root/outputTree");
      //chain->Add("../strobe_newsub/strobe_twose_reader_1.root/outputTree");
      //chain->Add("../nu_mc_dirt_newsub/nu_mc_dirt_reader.root/outputTree");
      chain->Add("../nu_mc_qtcorr_newsub/nu_mc_qtcorr_reader_0.root/outputTree");
      chain->Add("../nu_mc_qtcorr_newsub/nu_mc_qtcorr_reader_1.root/outputTree");
      chain->Add("../nu_mc_qtcorr_newsub/nu_mc_qtcorr_reader_2.root/outputTree");
      chain->Add("../nu_mc_disc_newsub/nu_mc_disc_reader_0.root/outputTree");
      chain->Add("../nu_mc_disc_newsub/nu_mc_disc_reader_1.root/outputTree");
      chain->Add("../nu_mc_disc_newsub/nu_mc_disc_reader_2.root/outputTree");
      chain->Add("../nu_data_newsub/nu_data_reader_0.root/outputTree");
      chain->Add("../nu_data_newsub/nu_data_reader_1.root/outputTree");
      tree = chain;
#endif // SINGLE_TREE
