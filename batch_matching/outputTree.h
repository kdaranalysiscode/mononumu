...
// Sat Oct 15 07:28:11 2016 by ROOT version 4.00/08
...
#include <TFile.h>
   ...
   const Int_t kMaxmyTankHeader = 1;
   const Int_t kMaxmyMCEvent = 1;
   const Int_t kMaxmyMCParticle = 1;
   const Int_t kMaxmyMCParent = 1;
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      chain->Add("/scratch/condor-tmp/grange/numi_data_nubar_newsub/numi_nubar_data_reader_final_22.root/outputTree");
      chain->Add("/scratch/condor-tmp/grange/numi_data_nubar_newsub/numi_nubar_data_reader_final_23.root/outputTree");
      chain->Add("/scratch/condor-tmp/grange/numi_data_nubar_newsub/numi_nubar_data_reader_final_24.root/outputTree");
      chain->Add("/scratch/condor-tmp/grange/numi_data_nubar_newsub/numi_nubar_data_reader_final_25.root/outputTree");
      chain->Add("/scratch/condor-tmp/grange/numi_data_nubar_newsub/numi_nubar_data_reader_final_26.root/outputTree");
      chain->Add("/scratch/condor-tmp/grange/numi_data_nubar_newsub/numi_nubar_data_reader_final_27.root/outputTree");
      chain->Add("/scratch/condor-tmp/grange/numi_data_nubar_newsub/numi_nubar_data_reader_final_28.root/outputTree");
      chain->Add("/scratch/condor-tmp/grange/numi_data_nubar_newsub/numi_nubar_data_reader_final_35.root/outputTree");
      chain->Add("/scratch/condor-tmp/grange/numi_data_nubar_newsub/numi_nubar_data_reader_final_36.root/outputTree");
      chain->Add("/scratch/condor-tmp/grange/numi_data_nubar_newsub/numi_nubar_data_reader_final_37.root/outputTree");
      chain->Add("/scratch/condor-tmp/grange/numi_data_nubar_newsub/numi_nubar_data_reader_final_38.root/outputTree");
      chain->Add("/scratch/condor-tmp/grange/numi_data_nubar_newsub/numi_nubar_data_reader_final_39.root/outputTree");
      tree = chain;
#endif // SINGLE_TREE
